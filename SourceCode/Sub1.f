...
c
c     --- Calculate Kappa (Local Dihedral Angle) ----(Start Code - updated by Bhima on 05.052026)
      if (r .le. 2.8667) then
         kappa = 0.0
      else
         kappa = 0.09955
...
c
     ...
     +               iter,err,th,nameprout,iters,dFx,dFz,kappa
c
...
100   format(7f8.3,2f8.1,5f8.3,3f9.1,i8,x,e8.1,x,f8.6,x,a4,x,a2, 3f9.1)
101   format(14a8,             4a9,       a8,    a9,    a5,  a3, 3a9)
