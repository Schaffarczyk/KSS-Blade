...
c
c       -------------------------------------------------------------------
c       Calculate radial induction (ur) & new axial induction (a)
c       -------------------------------------------------------------------
...
c
	abem(i) = anew
        apbem(i)= apnew
c
c       Include radial velocity component and drag in circulation ----(Start Code - updated by Bhima on 26.05.2026, 22.06.2026)
        w2  = w2 + ur*ur
...
c       Write section results to output files
     ...
     +                 err, th, iters, dFx, dFz, kappa, cthr, ur)
...
c=======================================================================
      ...
      real ct, dTa, dFta, gam, err, th, dFx, dFz, kappa, cthr, ur
      integer iter
      character*2 iters
      real r2d
